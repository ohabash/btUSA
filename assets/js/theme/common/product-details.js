...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        const $addButton = $('[data-addButton]', $scope);
    ...
    addProductToCart(event, form) {
        ...
        utils.api.cart.itemAdd(new FormData(form), (err, response) => {
            ...
            if (this.previewModal) {
                ...
                this.updateCartContent(response.data.cart_item.hash);
            } else {
                this.$overlay.show();
     ...
     * @param {Function} onComplete
     */
    updateCartContent(cartItemHash, onComplete) {
        ...
        this.getCartContent(cartItemHash, (err, response) => {
            ...
            // console.log('getCartContent response: ',response);
            $confirmationPop.html(response).removeClass('hide');

            // Update cart counter
            const $body = $('body');
            const $cartQuantity = $('[data-cart-quantity]', $confirmationPop);
            ...
            setTimeout( function() {
                self.hide_popup($confirmationPop);
            },5000);
